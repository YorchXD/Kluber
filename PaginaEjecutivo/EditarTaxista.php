...
<body>
	...
	<div id="div1" class="container" style="text-align: center;">
	  <h2 style="text-align: center;">Editar Chofer</h2>

	  <div class="container" style="text-align: center;">
	  	<h4 style="text-align: center;">Ingrese Correo del Chofer</h4>
	  ...
	  <form class="form-horizontal" action="/action_page.php">
		  ...
		  <div class="form-group">
		      ...
		      <div id="div5" class="col-sm-15">
		        <input type="Correo1" class="form-control" id="Correo1" placeholder="Correo" name="Correo1">
		      </div>
		   </div>
